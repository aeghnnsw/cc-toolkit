---
name: handoff
description: Create a concise handoff document so a fresh Codex or Claude Code session can continue the current work. Use when the user asks to hand off work, transfer context, resume later, compact a conversation, or prepare another agent or session to take over.
---
